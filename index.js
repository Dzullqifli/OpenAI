const sessionName = "DzullKz";
const donet = "https://saweria.co/DzullKz";
const owner = ["6282199086847"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator https://saweria.co/DzullKz", "yellow"));
